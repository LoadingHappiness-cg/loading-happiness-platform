      ...
      items: [
        {
          ...
          description: 'Stability, security, long-term clarity.',
        },
        {
          label: 'Philosophy & values',
          href: '/about#philosophy-values',
          description: 'Human clarity + technical discipline.',
        },
        {
          label: 'Partnership',
          href: '/about#partnership',
          description: 'What you get and what we need.',
        },
        {
          label: 'Our approach',
          href: '/about#our-approach',
          description: 'Assess → stabilize → evolve.',
        },
        {
          label: 'Why choose us',
          href: '/about#why-choose-us',
          description: 'Senior decisions, vendor-neutral.',
        },
        {
          label: 'Our team',
          href: '/about#our-team',
          description: 'Senior core + trusted network.',
        },
      ],
    },
    {
