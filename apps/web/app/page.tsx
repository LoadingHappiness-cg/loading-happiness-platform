          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/contact" className="px-10 py-4 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 shadow-xl shadow-blue-100 transition-all text-center">
                  Book a call
                </Link>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-10">
            ...
            <Link href="/services" className="text-sm font-bold text-blue-600 hover:text-blue-700">All services →</Link>
          </div>
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link href="/contact" className="px-8 py-3 bg-white/10 text-white rounded-xl font-bold hover:bg-white/20 transition-all">
              Send a message
            </Link>
          </div>
        </div>
